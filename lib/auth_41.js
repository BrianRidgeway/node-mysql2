...
function sha(type, msg, msg1, msg2) {
...
function sha1(msg, msg1, msg2) {
  return sha('sha1', msg, msg1, msg2);
}

function sha256(msg, msg1, msg2) {
  return sha('sha256', msg, msg1, msg2);
}
exports.sha256 = sha256;

function calculateSha2FastToken(password, scramble) {
  let passwordBuffer = Buffer.from(password, 'ascii');

  const authToken = xor(
    sha256(sha256(sha256(passwordBuffer)), scramble.slice(0, 20)),
    sha256(passwordBuffer)
  );
  return authToken;
}
exports.calculateSha2FastToken = calculateSha2FastToken;
